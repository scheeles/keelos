# pkg/init (KeelOS Init)

**Responsibility**: PID 1 logic.

This package contains the core logic for the custom init process. `keel-init` is responsible for the very first steps of userspace.
...
4.  **Service Supervision**:
    *   Spawn `keel-agent` (PID 2) as a child.
